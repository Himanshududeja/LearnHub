  ...
  const features = [
    {
      ...
      description: 'Get instant doubt resolution and personalized recommendations with our advanced AI assistant.',
    ...
    },
    {
      ...
      description: 'Earn industry-recognized certificates upon completion to showcase your achievements.',
    ...
    },
    {
      ...
      description: 'Join a vibrant community of learners. Discuss, collaborate, and grow together.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h3 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600"> Succeed</span>
          </h3>
          <p className="text-xl text-gray-600">
            Our platform provides cutting-edge tools and features designed to make your learning experience exceptional.
          </p>
        </div>
